"""
Django settings for afrikanvoice project.
...
ROOT_URLCONF = 'afrikanvoice.urls'
...
WSGI_APPLICATION = 'afrikanvoice.wsgi.application'
...
LOGOUT_REDIRECT_URL = 'post_list'  # Redirects to the post list after logout
